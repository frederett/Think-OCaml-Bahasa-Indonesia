...
Perintah {\tt opam init} menyiapkan terminal pengguna untuk keperluan {\bt OPAM}. 
Perintah {\tt opam switch create 4.14.0} memasang kompilator, versi kompilator pada contoh ini 4.14.0. 
...
Perhatikan bahwa lokasi folder saat ini ({\it current directory} \footnote{{\bf current directory} adalah lokasi folder untuk OCaml mencari berkas yang akan dijalankan, diluar perfolderan standar OCaml}) ketika membuka {\it toplevel} akan berada di lokasi folder yang sama pada terimnal anda saat ini.
Anda bisa mengubah lokasi folder dengan {\it directive} {\tt \#cd ``{\it namafolder}'';;}.
...
Percaya atau tidak, itu sudah semuanya. Setiap program yang anda pernah gunakan, tidak perduli betapa rumitnya, tersusun dari kumpulan instruksi seperti ini. Sehingga anda dapat melihat pemrograman sebagai proses memecah perkerjaan besar dan rumit menjadi kumpulan perkerjaan yang lebih kecil sampai cukup sederhana untuk dilakukan oleh salah satu instruksi dasar diatas.
...
Bagi sebagian orang, programan dan awakutu dianggap sama. Oleh karenanya, pemrogramman adalah proses bertahap mengawakutu 
