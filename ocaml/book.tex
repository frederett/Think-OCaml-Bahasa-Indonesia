...
Lampung dan Inggris. Bahasa tersebut tidak dirancangan oleh orang (meskipun beberapa ada usaha untuk membakukanya); 
...
yang benar secara sintaksis\footnote{Sintaksis sinonim dari tata tulis}. $H_2O$ adalah formula kimia yang benar tetapi
$_2Zz$ tidak.
...
seperti kata-kata, angka, dan unsur kimia. Salah satu masalah dari $3 + = 3 \mbox{\$} 6$  adalah simbol $\$$ bukan token resmi 
dalam matematika (yang saya tahu saat ini). Mirip dengan , $_2Zz$ yang bukan token legal dalam kimia karena tidak ada unsur 
dengan singkatan $Zz$.
